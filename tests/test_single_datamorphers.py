...
def test_add_column():
    ...
    - AddColumn:
        ...
        value: 999
    """
    config = get_pipeline_config(yaml_path=YAML_PATH, pipeline_name='pipeline_AddColumn')
...
def test_columns_operator():
    ...
    """
    config = get_pipeline_config(yaml_path=YAML_PATH, pipeline_name='pipeline_ColumnsOperator')
...
def test_remove_columns():
  ...
  - RemoveColumns:
    ...
    """
    config = get_pipeline_config(yaml_path=YAML_PATH, pipeline_name='pipeline_RemoveColumns')
